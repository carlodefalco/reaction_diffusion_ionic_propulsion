...
##  eqs=M*udot+A*u-F;
  eqs=[Mk*n1dot + A1(2:end-1,2:end-1)*n1-Mk*f_1;
  Mk*n2dot + A2(2:end-1,2:end-1)*n2-Mk*f_2;
  Mk*n3dot + A3(2:end-1,2:end-1)*n3-Mk*f_3;
  Mk*n4dot + A4(2:end-1,2:end-1)*n4-Mk*f_4;
  Mk*n5dot + A5(2:end-1,2:end-1)*n5-Mk*f_5;
  Mk*n6dot + A6(2:end-1,2:end-1)*n6-Mk*f_6;
  P(2:end-1, 2:end-1)*phi-f_phi];
