...
mass2=M;
mass={mass1; mass2};
rate={@(y,t) assembly_rate_transport(t, y, x, idx, valence, mobility,BC_species, BC_phi,N, q, epsilon, Vth, P, Mk,ui, tau);
      @(y,t) assembly_rate_chem(t, y, x, idx, valence, mobility,BC_species, BC_phi,N, q, epsilon, Vth, P, Mk,ui, tau)
      };
jacrate={@(y,t) assembly_jacrate_transport(t, y, x, idx, valence, mobility,BC_species, BC_phi,N, q, epsilon, Vth, P, Mk,ui, tau);
         @(y,t) assembly_jacrate_chem  (t,y, x, idx, valence, mobility,BC_species, BC_phi,N, q, epsilon, Vth, P, Mk,ui, tau) };
