function [u, error] = integrate_adaptive (u0, tspan, tol, mag, rate, jacrate, mass, nodal_trans, boundary_values)
  ...
  for ispan = 1 : numel (tspan) - 1
    ...
    while (t < tspan(ispan + 1))
      ...
      [unew,ut_chem, err]   = lbwe_step_splitting (u0, t, dt, rate, jacrate, mass, mag, nodal_trans, boundary_values);
      counter+=1;
      err;
